...
Each task (except T4) can also be run directly in Frama-C with the option indicated in the list above. For example, T1 can be run using `frama-c -vernfr -nfr-check-calls -nfr-ispec test.is test.c`   
